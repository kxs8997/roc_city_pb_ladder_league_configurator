...
class SeededLadderLeague:
    def __init__(self):
        ...
        # Precomputed 9-round schedules per tier size (0-indexed player positions).
        # Generated by backtracking solver; all verified for unique partnerships.
        # No-consecutive-sit-out is also satisfied where mathematically possible:
        #   7 players (3 sit/round): both constraints fully satisfied
        #   8 players (4 sit/round): 2 unavoidable consecutive sit-outs
        #   9 players (5 sit/round): consecutive unavoidable (2×5 > 9)
        #  10 players (6 sit/round): consecutive unavoidable (2×6 > 10)
        self.tier_templates = {
            7: [
                {'teams': [(0, 1), (2, 3)], 'sitting': [4, 5, 6]},
                {'teams': [(4, 6), (3, 5)], 'sitting': [0, 1, 2]},
                {'teams': [(0, 2), (1, 6)], 'sitting': [3, 4, 5]},
                {'teams': [(3, 4), (2, 5)], 'sitting': [0, 1, 6]},
                {'teams': [(0, 6), (1, 5)], 'sitting': [2, 3, 4]},
                {'teams': [(1, 3), (2, 4)], 'sitting': [0, 5, 6]},
                {'teams': [(0, 4), (5, 6)], 'sitting': [1, 2, 3]},
                {'teams': [(0, 3), (1, 2)], 'sitting': [4, 5, 6]},
                {'teams': [(3, 6), (4, 5)], 'sitting': [0, 1, 2]},
            ],
            8: [
                {'teams': [[4, 7], [1, 2]], 'sitting': [0, 3, 5, 6]},
                {'teams': [[0, 5], [3, 6]], 'sitting': [1, 2, 4, 7]},
                {'teams': [[2, 7], [1, 4]], 'sitting': [0, 3, 5, 6]},
                {'teams': [[3, 5], [0, 6]], 'sitting': [1, 2, 4, 7]},
                {'teams': [[1, 7], [2, 4]], 'sitting': [0, 3, 5, 6]},
                {'teams': [[5, 6], [0, 3]], 'sitting': [1, 2, 4, 7]},
                {'teams': [[6, 7], [4, 5]], 'sitting': [0, 1, 2, 3]},
                {'teams': [[0, 2], [1, 3]], 'sitting': [4, 5, 6, 7]},
                {'teams': [[4, 6], [5, 7]], 'sitting': [0, 1, 2, 3]},
            ],
            9: [
                {'teams': [[1, 6], [3, 8]], 'sitting': [0, 2, 4, 5, 7]},
                {'teams': [[2, 5], [4, 7]], 'sitting': [0, 1, 3, 6, 8]},
                {'teams': [[6, 8], [1, 3]], 'sitting': [0, 2, 4, 5, 7]},
                {'teams': [[2, 7], [4, 5]], 'sitting': [0, 1, 3, 6, 8]},
                {'teams': [[3, 6], [1, 8]], 'sitting': [0, 2, 4, 5, 7]},
                {'teams': [[5, 7], [2, 4]], 'sitting': [0, 1, 3, 6, 8]},
                {'teams': [[6, 7], [0, 8]], 'sitting': [1, 2, 3, 4, 5]},
                {'teams': [[1, 4], [3, 5]], 'sitting': [0, 2, 6, 7, 8]},
                {'teams': [[2, 6], [7, 8]], 'sitting': [0, 1, 3, 4, 5]},
            ],
            10: [
                {'teams': [[2, 5], [6, 8]], 'sitting': [0, 1, 3, 4, 7, 9]},
                {'teams': [[7, 9], [3, 4]], 'sitting': [0, 1, 2, 5, 6, 8]},
                {'teams': [[2, 8], [5, 6]], 'sitting': [0, 1, 3, 4, 7, 9]},
                {'teams': [[3, 9], [4, 7]], 'sitting': [0, 1, 2, 5, 6, 8]},
                {'teams': [[2, 6], [5, 8]], 'sitting': [0, 1, 3, 4, 7, 9]},
                {'teams': [[4, 9], [3, 7]], 'sitting': [0, 1, 2, 5, 6, 8]},
                {'teams': [[1, 6], [0, 8]], 'sitting': [2, 3, 4, 5, 7, 9]},
                {'teams': [[5, 7], [2, 9]], 'sitting': [0, 1, 3, 4, 6, 8]},
                {'teams': [[4, 6], [3, 8]], 'sitting': [0, 1, 2, 5, 7, 9]},
            ],
            11: [
                {'teams': [[4, 8], [5, 9]], 'sitting': [0, 1, 2, 3, 6, 7, 10]},
                {'teams': [[3, 6], [7, 10]], 'sitting': [0, 1, 2, 4, 5, 8, 9]},
                {'teams': [[5, 8], [4, 9]], 'sitting': [0, 1, 2, 3, 6, 7, 10]},
                {'teams': [[3, 7], [6, 10]], 'sitting': [0, 1, 2, 4, 5, 8, 9]},
                {'teams': [[8, 9], [4, 5]], 'sitting': [0, 1, 2, 3, 6, 7, 10]},
                {'teams': [[6, 7], [3, 10]], 'sitting': [0, 1, 2, 4, 5, 8, 9]},
                {'teams': [[1, 9], [2, 8]], 'sitting': [0, 3, 4, 5, 6, 7, 10]},
                {'teams': [[5, 10], [4, 7]], 'sitting': [0, 1, 2, 3, 6, 8, 9]},
                {'teams': [[3, 8], [6, 9]], 'sitting': [0, 1, 2, 4, 5, 7, 10]},
            ],
            12: [
                {'teams': [[1, 11], [2, 4]], 'sitting': [0, 3, 5, 6, 7, 8, 9, 10]},
                {'teams': [[7, 9], [8, 10]], 'sitting': [0, 1, 2, 3, 4, 5, 6, 11]},
                {'teams': [[4, 5], [6, 11]], 'sitting': [0, 1, 2, 3, 7, 8, 9, 10]},
                {'teams': [[7, 10], [8, 9]], 'sitting': [0, 1, 2, 3, 4, 5, 6, 11]},
                {'teams': [[4, 11], [5, 6]], 'sitting': [0, 1, 2, 3, 7, 8, 9, 10]},
                {'teams': [[9, 10], [7, 8]], 'sitting': [0, 1, 2, 3, 4, 5, 6, 11]},
                {'teams': [[5, 11], [4, 6]], 'sitting': [0, 1, 2, 3, 7, 8, 9, 10]},
                {'teams': [[2, 10], [3, 9]], 'sitting': [0, 1, 4, 5, 6, 7, 8, 11]},
                {'teams': [[7, 11], [6, 8]], 'sitting': [0, 1, 2, 3, 4, 5, 9, 10]},
            ],
        }
    ...
    def _generate_tiered_round(self, current_round_num):
        """Generate round for any number of players per tier.
        Uses precomputed templates for 7-10 player tiers (unique partnerships guaranteed).
        Falls back to backtracking algorithm for other tier sizes."""
        from itertools import combinations
        ...
        for tier_num in [1, 2, 3, 4]:
            ...
            court_num = active_assigned_courts[0]
            num_tier_players = len(tier_players)
            
            if num_tier_players in self.tier_templates:
                # Use precomputed template for known tier sizes (7-10 players)
                round_idx = (current_round_num - 1) % 9
                template = self.tier_templates[num_tier_players][round_idx]
                team1 = [tier_players[i] for i in template['teams'][0]]
                team2 = [tier_players[i] for i in template['teams'][1]]
                sitting = [tier_players[i] for i in template['sitting']]
                courts.append(self._create_court_data(court_num, team1 + team2))
                all_sitting.extend(sitting)
            else:
                # General backtracking algorithm for other tier sizes
                playing, sitting = self._find_valid_tier_assignment(
                    tier_players, 4, current_round_num
                )
                if playing and len(playing) >= 4:
                    courts.append(self._create_court_data(court_num, playing[:4]))
                all_sitting.extend(sitting)
        
        return self._finalize_round(current_round_num, courts, all_sitting)
    
    def _find_valid_tier_assignment(self, tier_players, players_needed, current_round_num):
        """Find a valid assignment of players ensuring:
        1. No player who sat last round sits again
        2. All partnerships are unique (not used before in session)
        Returns (playing_list, sitting_list) or falls back to random if no valid combo."""
        from itertools import combinations
        
        # Players who sat last round MUST play this round
        must_play = set()
        for p in tier_players:
            if self.player_stats[p]['last_sat_out_round'] == current_round_num - 1:
                must_play.add(p)
        
        # Players who CAN sit (didn't sit last round)
        can_sit = [p for p in tier_players if p not in must_play]
        
        num_sitting = len(tier_players) - players_needed
        
        if num_sitting < 0:
            # Not enough players
            return tier_players[:players_needed], tier_players[players_needed:]
        
        if num_sitting == 0:
            # Everyone plays, just need to find valid partnerships
            playing = list(tier_players)
            result = self._find_valid_partnerships(playing, players_needed // 2)
            if result:
                return result, []
            random.shuffle(playing)
            return playing[:players_needed], []
        
        # Need to choose who sits - prioritize those who played more games
        can_sit_sorted = sorted(can_sit, 
                                key=lambda p: (self.player_stats[p]['games_played'], 
                                              -self.player_stats[p]['rounds_sat_out']), 
                                reverse=True)
        
        # Try combinations of who sits out
        for sit_combo in combinations(can_sit_sorted, min(num_sitting, len(can_sit_sorted))):
            sitting = list(sit_combo)
            playing = [p for p in tier_players if p not in sitting]
            
            if len(playing) < players_needed:
                continue
            
            # Try to find valid partnerships from these players
            result = self._find_valid_partnerships(playing[:players_needed], players_needed // 2)
            if result:
                extra_sitting = playing[players_needed:]
                return result, sitting + extra_sitting
        
        # Fallback: use regular selection (may have repeat partnerships)
        sitting = self.select_sitting_players(tier_players, players_needed, current_round_num)
        playing = [p for p in tier_players if p not in sitting]
        random.shuffle(playing)
        return playing[:players_needed], sitting + playing[players_needed:]
    
    def _find_valid_partnerships(self, players, teams_needed):
        """Find teams_needed pairs of players with no repeat partnerships.
        Returns flat list of players arranged as [team1_p1, team1_p2, team2_p1, team2_p2, ...]
        or None if no valid arrangement found."""
        from itertools import combinations
        
        # Get all valid (unused) partnerships from these players
        valid_pairs = []
        for p1, p2 in combinations(players, 2):
            if self.is_valid_partnership(p1, p2):
                valid_pairs.append((p1, p2))
        
        # Backtracking to find non-overlapping pairs
        def find_teams(pairs, selected, used_players):
            if len(selected) == teams_needed:
                return selected
            for i, pair in enumerate(pairs):
                if pair[0] not in used_players and pair[1] not in used_players:
                    result = find_teams(pairs[i+1:], selected + [pair], 
                                        used_players | {pair[0], pair[1]})
                    if result:
                        return result
            return None
